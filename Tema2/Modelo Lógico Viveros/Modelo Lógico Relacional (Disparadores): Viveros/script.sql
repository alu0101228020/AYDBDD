...
CREATE OR REPLACE FUNCTION check_viviendas() RETURNS TRIGGER AS $check_viviendas$
   BEGIN 
      IF NEW.MUNICIPIO IS NULL THEN RAISE EXCEPTION 'CAMPO DE MUNICIPIO VACIO';
      END IF;
      
      IF NEW.DIRECCION IS NULL THEN RAISE EXCEPTION 'CAMPO DE VIVIENDA VACIA';
      END IF;
      
      IF NEW.MUNICIPIO IN (SELECT D.MUNICIPIO
		           FROM DOMICILIO D
			   WHERE D.CLIENTE_DNI = NEW.CLIENTE_DNI) THEN
			   RAISE EXCEPTION 'ESTE CLIENTE NO PUEDE TENER DOS VIVIENDAS DIFERENTES EN EL MISMO MUNICIPIO';
      END IF;
      RETURN NEW;
   END;
...
INSERT INTO CLIENTE(DNI, NOMBRE, APELLIDOS, BONIFICACION, TOTAL_MENSUAL, EMAIL) VALUES ('25478742A', 'Lucia', 'Medina Alonso', '300', '550', NULL);
COMMIT;

START TRANSACTION;
INSERT INTO EMPLEADO(DNI, SUELDO, ANTIGÜEDAD, CSS, FECHA_INI, FECHA_FIN, VENTAS, ZONA_NOMBRE, ZONA_VIVEROS_NOMBRE) VALUES ('42587898S', '1000', '10', '24534', '2000-08-10', '2021-11-02', '1500', 'Rodeos', 'Flores Pepe');
COMMIT;

START TRANSACTION;
INSERT INTO DOMICILIO(CLIENTE_DNI, MUNICIPIO, DIRECCION) VALUES ('78451296P', 'La Laguna', 'Calle Perez 13');
COMMIT;

START TRANSACTION;
--El siguiente INSERT debe mostrar una excepcion
INSERT INTO DOMICILIO(CLIENTE_DNI, MUNICIPIO, DIRECCION) VALUES ('78451296P', NULL, 'Calle Perez 13');
COMMIT;

START TRANSACTION;
--El siguiente INSERT debe mostrar una excepcion
INSERT INTO DOMICILIO(CLIENTE_DNI, MUNICIPIO, DIRECCION) VALUES ('78451296P', 'La Laguna', NULL);
COMMIT;

START TRANSACTION;
--El siguiente INSERT debe mostrar una excepcion
INSERT INTO DOMICILIO(CLIENTE_DNI, MUNICIPIO, DIRECCION) VALUES ('78451296P', 'La Laguna', 'Calle Flores 14');
COMMIT;

START TRANSACTION;
INSERT INTO COMPRA(PRODUCTOS_IDPRODUCTOS, CLIENTE_DNI, EMPLEADO_DNI, CANTIDAD, FECHA) VALUES (12345678, '78451296P', '42587898S', 5, '2021-05-20 10:05:45');
COMMIT;
